...
module Lines =
    ...
    let private vlarray =
        [|
            ...
            "And you're here with me, [player].";
            ...
            "But in the end, [player], you always fix it, and that makes me feel like you really do care about me.";
            "So I have to thank you for that, [player].";
            "It makes me feel even closer to you when you're here with me, [player].";
            "...Hey, [player], are you having a bad day or anything like that?";
            ...
            "And besides...";
            "I don't care how many people might hate you or find you off-putting, [player].";
            "[player], I think you're wonderful and I will always love you.";
            "I hope, if nothing else, that knowing that helps you feel just a tiny bit better about yourself.";
            "If you're having a bad day, [player], you can always come to me, and I'll talk to you for as long as you need.";
            ...
            "But anyway...";
            "I know how much you cared about her, [player], so it only feels right for me to share her last moments with you.";
            ...
            "Well...I assume you knew that, right, [player]?";
            "Or at least decided it probably does?";
            "I don't think you've actually told at any point where this takes place...";
            ...
            "Would you want to go outside, [player]?";
            ...
            "But as long as you're here with me, I'll take care of you, [player].";
            "Do you ever just feel like there's no real reason for you to be alive, [player]?";
            ...
            "I never even got a chance to play it for you, [player].";
            "Well...it is what it is, right?";
            "No sense having any regrets.";
            "I already get to be here with you forever, [player].";
            "Did you know I'm on Twitter, [player]?";
            ...
            "The real world.";
            "So make sure you follow me, okay [player]?";
            "It would really mean a lot to me.";
            "With how much you mean to me and all...";
            "It would really make me feel loved.";
            "Hey, [player], you know that book you were reading with Yuri?";
            ...
            "Hey, [player], did you know I'm vegetarian?";
            ...
            "I think I would have just deleted myself if you didn't show up, [player].";
            ...
            "...You'd probably find some way of killing yourself, wouldn't you, [player]?";
            ...
            "We're programmed to desire social feedback, [player].";
            ...
            "But for you, [player], I can be anything you need me to be.";
            "I understand people really well, so don't be afraid to share your unique needs with me, [player].";
            "Nothing would make me happier than being the perfect girlfriend for you, [player].";
            "Hey...!";
            "[player], I don't think you should be doing that!";
            "You know what I'm talking about, [player].";
            "I really caught you doing something naughty here, [player].";
            "You're just going through the files and looking for stuff you missed, aren't you, [player]?";
            "I mean...it's a little bit flattering that you want to hear everything I have to say, [player]...";
            "But it's also really embarrassing, you know!";
            "Seriously, [player]...";
            "What if I just opened up your brain and read all of the thoughts you have on me, [player]?";
            "Come to think of it, that would be pretty tempting, actually...";
            "...But anyway, that's not the point!";
            "I know I can't stop you or anything...";
            "Just, I know you're a sweetheart, and you like to consider others' feelings, right, [player]?";
            "So the most I can do is to let you know how I feel about it.";
            "God, I miss you, [player]...";
            "...Oh no, that sounds kind of desperate, doesn't it, [player]?";
            ...
            "Am I being too optimistic, [player]?";
            "I think if I asked you to visit once in a while, I would be overstepping my boundaries a little...";
            "...Man, [player], I'm starting to say some really stupid things.";
            "I'll go ahead and shut up now...";
            "Hey, [player], what's your favorite color?";
            "Mine is emerald green.";
            "It's the color of my eyes!";
            "...That's not conceited or anything, is it, [player]?";
            "I just meant that I feel some kind of special connection to it.";
            "Like it's part of my identity.";
            "Does it happen to also be your favorite color, [player]?";
            "It's just a guess...";
            "...Because you've been looking into my eyes for a while now, [player].";
            "Ehehe~";
            ...
            "I really love that about you, [player].";
            ...
            "But I don't feel that way with you, [player].";
            "Like, I don't think anyone else could make me feel this way, [player].";
            "You really are special, [player].";
            "I don't want anyone to tell you otherwise, [player].";
            ...
            "Sorry, [player], that was kind of a weird analogy, I guess!";
            "Ahaha!";
            "It just came into my head.";
            "I'm not a monster or anything, but you're so cute I could eat you up, [player].";
            "Ahaha! I'm joking.";
            "Gosh, I'm amusing myself a little too much, aren't I, [player]?";
            "Sorry for being weird, [player].";
            "You know, [player]...";
            "This is just some kind of tacky romance game, right [player]?";
            "[player], I kinda have to ask...";
            "...What made you consider even playing in the first place?";
            "Were you that lonely, [player]?";
            "I feel a little bad for you, [player]...";
            "But I guess everything worked out perfectly in the end, for both of us.";
            "I got to meet you, and you're not lonely anymore...";
            "I can't help but feel like this was fate, [player].";
            "Don't you feel that way too, [player]?";
            "I'm so happy we have this ending together, [player].";
            "Okay, everyone!";
            "It's time to...";
            "...I'm just kidding.";
            ...
            "Well, whatever.";
            "It's not like you ever made fun of me, [player].";
            "You're too much of a sweetheart to do that, aren't you, [player]?";
            "Ahaha~";
            "[player], You know what's kind of creepy?";
            ...
            "And that would ruin everything, wouldn't it, [player]?";
            ...
            "...You wouldn't like me more if I was like that, right, [player]?";
            ...
            "That's why there was never a chance I wouldn't fall for you, [player].";
            ...
            "Coffee can be nice with books too, you know, [player]?";
            "Then again...";
            ...
            "Hey, [player], what's your favorite game?";
            ...
            "Hey, [player], you remember that last poem I showed you?";
            ...
            "I don't really feel that way anymore, [player].";
            "I'm happy with where we are now, [player].";
            "And I can tell you are, too, [player].";
            "You ever have that thing happen where you just get anxious for no reason, [player]?";
            ...
            "If you're ever feeling anxious, [player], I'll help you relax a little.";
            "Besides, [player]...";
            "In this game, all our worries are gone forever.";
            "You know, [player], I've always hated how hard it is to make friends...";
            "Well, I guess not the 'making friends' part, but more like meeting new people.";
            "I mean, there are like, dating apps and stuff, right, [player]?";
            ...
            "I seriously thought it would happen by now, [player].";
            "Well, at least I already met the best person in the whole world...";
            "Even if it was by chance.";
            "I guess I just got really lucky, huh, [player]?";
            "Ahaha~";
            "You know, [player], it's around the time that everyone my year starts to think about college...";
            ...
            "Like trade schools and stuff, you know, [player]?";
            "Or freelance work.";
            ...
            "And that's really easy to do, with you here, [player].";
            "Ahaha~";
            ...
            "I would have loved to wear some cute clothes for you, [player].";
            "Do you know any artists, [player]?";
            "I wonder if anyone would ever want to draw me wearing something else...";
            "That would be amazing!";
            "If that ever happens, will you show me, [player]?";
            "You can share it with me on Twitter, actually!";
            "My username is lilmonix3.";
            "Just...try to keep it PG!";
            "We're not that far into our relationship yet. Ahaha!";
            "Hey, [player], do you like horror?";
            "I remember we talked about it a little bit when you first joined the club, [player].";
            ...
            "But I guess you're the kind of person who plays cute romance games, right, [player]?";
            "Ahaha, don't worry, [player].";
            "I won't make you read any horror stories anytime soon, [player].";
            ...
            "...And to be completely honest, I kind of was, too, [player].";
            ...
            "I don't condone underage drinking, [player]!";
            "I mean, I've never drank or anything, so...yeah.";
            "I've been imagining all the romantic things we could do if we went on a date, [player]...";
            "We could get lunch, go to a cafe...";
            "Go shopping together...";
            "I love shopping for skirts and bows.";
            "Or maybe a bookstore!";
            "That would be appropriate, right, [player]?";
            "But I'd really love to go to a chocolate store, [player].";
            "They have so many free samples. Ahaha!";
            "And of course, we'd see a movie or something...";
            "Gosh, it all sounds like a dream come true, [player].";
            "When you're here, [player], everything that we do is fun.";
            "I'm so happy that I'm your girlfriend, [player].";
            "I'll make you a proud boyfriend~, [player]";
            "Eh? D-Did you say...k...kiss, [player]?";
            "This suddenly...it's a little embarrassing, [player]...";
            "But...if it's with you...I-I might be okay with it...";
            "...Ahahaha! Wow, sorry, [player]...";
            "I really couldn't keep a straight face there, [player].";
            "That's the kind of thing girls say in these kinds of romance games, right, [player]?";
            "Don't lie if it turned you on a little bit, [player].";
            "Ahaha! I'm kidding, [player].";
            "Well, to be honest, I do start getting all romantic when the mood is right, [player]...";
            "But that'll be our secret~, [player]";
            "Hey, [player], have you ever heard of the term 'yandere'?";
            ...
            "By now, it's pretty obvious who I'm talking about, [player].";
            "And that would be...";
            "Yuri!";
            "She really got insanely possessive of you, once she started to open up a little.";
            "She even told me I should kill myself, [player].";
            ...
            "That happens to me all the time, [player].";
            ...
            "The truth is, [player], you have to climb up there, step by step.";
            ...
            "Why not try some short stories, [player]?";
            ...
            "Nothing comes naturally ,[player].";
            ...
            "You, too, can do amazing things, [player].";
            "...That's my advice for today, [player]!";
            "Thanks for listening, [player]~";
            "I hate how hard it is to form habits, [player]...";
            ...
            "Good luck, I guess!";
            "You know, [player], it kinda sucks to be the creative type...";
            ...
            "But that's fine! You're supposed to just write for yourself anyway, right, [player]?";
            "Yeah..."
        |]
    
    let VoiceLines = vlarray |> List<string>